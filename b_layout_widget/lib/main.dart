...
import '01_layout_widget/00_LayoutWidget.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: const[ // appBar의 오른쪽 끝에 표시될 위젯 목록이다. 보통 아이콘 버튼이나 메뉴를 추가한다.
          Icon(Icons.favorite)  // Icon 위젯은 아이콘을 화면에 표시하기 위한 위젯이다.
        ],
      ),
